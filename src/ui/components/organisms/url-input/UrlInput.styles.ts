...
export const StyledHeader = styled(Box)(({ theme }) => ({
  ...
  marginBottom: theme.spacing(1), // 0.5rem
}));
...
export const ToolTipButton = styled(Tooltip)(({ theme }) => ({
  ...
  // disable all Tooltip styles except for the background and boxShadow
  '& .MuiTooltip-arrow': {
    color: 'transparent',
  },
}));
...
export const StyledFooter = styled(Box)(({ theme }) => ({
  ...
  display: 'flex',
  justifyContent: 'space-between',
  marginTop: theme.spacing(1), // 0.5rem
}));
